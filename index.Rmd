...
abstract: |
  `r paste(readLines("content/matter/_abstract.Rmd"), collapse = '\n  ')`
acknowledgements: |
  `r paste(readLines("content/matter/_acknowledgements.Rmd"), collapse = '\n  ')`
dedication: For Yihui Xie
abbreviations: "content/matter/abbreviations" # path to .tex file with abbreviations
...
```{r ebook-welcome, child = 'content/matter/_welcome-ebook.Rmd', eval=knitr::is_html_output()}
```
