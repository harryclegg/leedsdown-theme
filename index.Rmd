...
global-table-of-contents: true
global-list-of-figures: true
global-list-of-tables: true
chapter-table-of-contents: true
chapter-list-of-figures: false
chapter-list-of-tables: false
...
output:
  bookdown::pdf_book:
    template: template/latex/template.tex
    keep_tex: true
    citation_package: biblatex  
    pandoc_args: "--lua-filter=template/scripts/colour_and_highlight.lua"
  bookdown::bs4_book: 
    css: 
      - template/web/bs4_style.css
      - template/web/corrections.css # remove to stop highlighting corrections
    theme:
      primary: "#6D1919"
    # repo: https://github.com/<github-username>/<github-repo>
    pandoc_args: "--lua-filter=template/scripts/colour_and_highlight.lua"
  bookdown::gitbook:
    css: template/web/style.css
    config:
      sharing:
        facebook: false
        twitter: yes
...
source('template/scripts/install_packages_if_missing.R')
```

```{r create_chunk_options, include=FALSE, eval=knitr::is_latex_output()}
source('template/scripts/create_chunk_options.R')
source('template/scripts/wrap_lines.R')
```
