...
\documentclass[a4paper,oneside,12pt]{template/latex/leedsthesis}
...
\crest{\oldincludegraphics[width=35mm]{template/crest.pdf}}
...
\input{template/latex/style/listingStyles}
