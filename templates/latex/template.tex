...
\newcommand{\unitcell}[2]{% \unitcell{text}{unit}
\begin{tabular}{@{}c@{}}%
    #1 \\ #2%
\end{tabular}%
}
\newcolumntype{a}[3]{>{\columncolor{#2}}#1{#3}}
\newcolumntype{z}[2]{>{\columncolor{#2}}#1}
...
\usepackage{soul}
\definecolor{correctioncolor}{HTML}{$correction-col$}
