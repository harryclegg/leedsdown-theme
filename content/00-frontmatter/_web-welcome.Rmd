...
<a href="_main.pdf" target="_blank"><img src="template/cover.png" alt="Download PDF" class="img-fluid"/></a> 
::::::
:::

## Abstract {-}
```{r abstract, child=here::here('content/00-frontmatter/_abstract.Rmd')}
```


## Acknowledgments {-}
```{r acknowledgments, child=here::here('content/00-frontmatter/_acknowledgements.Rmd')}
```
