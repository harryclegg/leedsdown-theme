...
library(tidyverse)
knitr::include_graphics("content/figures/sample-content/chunk-parts.png")
```
...
```{r oxford-logo, fig.cap="Leeds ceremonial crest", out.width='50%', fig.align='center'}
knitr::include_graphics("content/figures/sample-content/crest.png")
```
...
```{r oxford-logo-rotated, out.extra=rotate180, fig.cap="Leeds ceremonial crest, rotated", out.width='50%', fig.align='center', echo=FALSE}
knitr::include_graphics("content/figures/sample-content/crest.png")
```
...
```{r cars-plot, out.width="100%", fig.cap = "A ggplot of car stuff"}
cars %>% 
  ggplot() +
    aes(x = speed, y = dist) +
    geom_point()
...
```{r oxford-logo-controlled, fig.cap="An Leeds ceremonial crest that LaTeX will try to place at this position in the text", out.width='50%', fig.align='center', fig.pos="H"}
knitr::include_graphics("content/figures/sample-content/crest.png")
```
...
Therefore, it is not generally a good idea to do this - only do it when you really need to ensure that an image follows directly under text where you refer to it.
